...
- (IBAction)actionTime:(id)sender {
    ...
    [UIView animateWithDuration:.6 animations:^{
        ...
        [self.dialogView setEasingFunction:easeOutQuad forKeyPath:@"transform"];
...
- (IBAction)dismissDialog:(id)sender {
    ...
    [UIView animateWithDuration:.5 animations:^{
        ...
        [self.dialogView setEasingFunction:easeInBack forKeyPath:@"center"];
        [self.dialogView setEasingFunction:easeOutQuint forKeyPath:@"transform"];
